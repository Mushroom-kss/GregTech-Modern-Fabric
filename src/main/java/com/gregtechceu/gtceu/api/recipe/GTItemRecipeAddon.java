...
public class GTItemRecipeAddon implements FinishedRecipe{
    ...
    public GTItemRecipeAddon(@Nonnull String RecipeModId, @Nonnull String RecipeType, int InputAmount, String InputModId, Material InputMaterial, @Nonnull String InputType, int OutputAmount, String OutputModId, Material OutputMaterial, @Nonnull String OutputType) {
