...
import static com.gregtechceu.gtceu.common.data.GTMaterials.MATERIAL_AMOUNT_MAP;
...
public class TagPrefix {
    ...
    public static final TagPrefix ingotHot = new TagPrefix("hotIngot")
        ...
        .generationCondition(hasBlastProperty
                .and(mat -> mat.getProperty(PropertyKey.BLAST).getBlastTemperature() > 1750));
    ...
    public static final TagPrefix gemChipped = new TagPrefix("chippedGem")
        ...
        .generateItem(true)
        .generationCondition(hasGemProperty
                .and(unused -> ConfigHolder.INSTANCE.recipes.generateLowQualityGems));
    ...
    // Dust with impurities.  Unit of Main Material and 1/9 - 1/4 Unit of secondary
    // Material
    ...
    public static final TagPrefix plateDense = new TagPrefix("densePlate")
        ...
        .generationCondition(mat -> mat.hasFlag(MaterialFlags.GENERATE_DENSE)
                && !mat.hasFlag(MaterialFlags.NO_SMASHING));
    ...
    public static final TagPrefix plateDouble = new TagPrefix("doublePlate")
        ...
        .unificationEnabled(true)
        .generateItem(true)
        .generationCondition(hasIngotProperty.and(mat -> mat.hasFlag(MaterialFlags.GENERATE_PLATE)
                && !mat.hasFlag(MaterialFlags.NO_SMASHING)));
    ...
    public static final TagPrefix springSmall = new TagPrefix("smallSpring")
        ...
        .unificationEnabled(true)
        .generateItem(true)
        .generationCondition(mat -> mat.hasFlag(MaterialFlags.GENERATE_SPRING_SMALL)
                && !mat.hasFlag(MaterialFlags.NO_SMASHING));
    ...
    public static final TagPrefix spring = new TagPrefix("spring")
        ...
        .unificationEnabled(true)
        .generateItem(true)
        .generationCondition(mat -> mat.hasFlag(MaterialFlags.GENERATE_SPRING)
                && !mat.hasFlag(MaterialFlags.NO_SMASHING));
    ...
    // consisting out of 4 Plates,  Ring and  Screw.
    ...
    // 3/4 of a Plate or Gem used to shape a Lens. Normally only used on Transparent
    // Materials.
    ...
    public static final TagPrefix toolHeadBuzzSaw = new TagPrefix("buzzSawBlade")
        ...
        .unificationEnabled(true)
        .generateItem(true)
        .generationCondition(hasNoCraftingToolProperty
                .and(mat -> mat.hasFlag(MaterialFlags.GENERATE_PLATE)));
    ...
    public static final TagPrefix toolHeadScrewdriver = new TagPrefix("screwdriverTip")
        ...
        .generateItem(true)
        .generationCondition(hasNoCraftingToolProperty
                .and(mat -> mat.hasFlag(MaterialFlags.GENERATE_LONG_ROD)));
    ...
    public static final TagPrefix turbineBlade = new TagPrefix("turbineBlade")
        ...
        .unificationEnabled(true)
        .generateItem(true)
        .generationCondition(hasRotorProperty.and(
                m -> m.hasFlags(MaterialFlags.GENERATE_BOLT_SCREW, MaterialFlags.GENERATE_PLATE)
    ...
    public static final TagPrefix pipeSmallFluid = new TagPrefix("pipeSmallFluid")
        ...
        .miningToolTag(GTToolType.WRENCH.harvestTags.get(0)).materialAmount(GTValues.M)
        .unificationEnabled(true);
    ...
    public static final TagPrefix wireGtHex = new TagPrefix("wireGtHex").itemTable(() -> GTBlocks.CABLE_BLOCKS)
        ...
        .materialAmount(GTValues.M * 8).materialIconType(MaterialIconType.wire)
        .unificationEnabled(true);
    public static final TagPrefix wireGtOctal = new TagPrefix("wireGtOctal").itemTable(() -> GTBlocks.CABLE_BLOCKS)
        ...
        .materialAmount(GTValues.M * 4).materialIconType(MaterialIconType.wire)
        .unificationEnabled(true);
    ...
    public static final TagPrefix wireGtDouble = new TagPrefix("wireGtDouble")
        .itemTable(() -> GTBlocks.CABLE_BLOCKS).langValue("2x %s Wire")
        .miningToolTag(GTToolType.WIRE_CUTTER.harvestTags.get(0)).materialAmount(GTValues.M)
        .materialIconType(MaterialIconType.wire).unificationEnabled(true);
    public static final TagPrefix wireGtSingle = new TagPrefix("wireGtSingle")
        .itemTable(() -> GTBlocks.CABLE_BLOCKS).langValue("1x %s Wire")
        .miningToolTag(GTToolType.WIRE_CUTTER.harvestTags.get(0)).materialAmount(GTValues.M / 2)
        .materialIconType(MaterialIconType.wire).unificationEnabled(true);
    ...
    public static final TagPrefix cableGtOctal = new TagPrefix("cableGtOctal")
        .itemTable(() -> GTBlocks.CABLE_BLOCKS).langValue("8x %s Cable")
        .miningToolTag(GTToolType.WIRE_CUTTER.harvestTags.get(0)).materialAmount(GTValues.M * 4)
        .unificationEnabled(true);
    ...
    public static final TagPrefix cableGtDouble = new TagPrefix("cableGtDouble")
        .itemTable(() -> GTBlocks.CABLE_BLOCKS).langValue("2x %s Cable")
        .miningToolTag(GTToolType.WIRE_CUTTER.harvestTags.get(0)).materialAmount(GTValues.M)
        .unificationEnabled(true);
    public static final TagPrefix cableGtSingle = new TagPrefix("cableGtSingle")
        .itemTable(() -> GTBlocks.CABLE_BLOCKS).langValue("1x %s Cable")
        .miningToolTag(GTToolType.WIRE_CUTTER.harvestTags.get(0)).materialAmount(GTValues.M / 2)
        .unificationEnabled(true);
    ...
    public record OreType(Supplier<BlockState> stoneType, boolean isNether, boolean isSand, MapColor color,
        SoundType sound) {
    }
    ...
    public TagPrefix registerOre(Supplier<BlockState> stoneType, boolean isNether, MapColor color,
        SoundType soundType, boolean isSand) {
    ...
    public TagPrefix customTagPath(LoaderType loader, String path,
    ...
    public boolean doGenerateItem(Material material) {
        return (generateItem && !isIgnored(material)
            ...
            || (hasItemTable() && this.itemTable.get() != null
                && getItemFromTable(material) != null);
    }

    public <T extends IMaterialProperty<T>> void executeHandler(PropertyKey<T> propertyKey,
        TriConsumer<TagPrefix, Material, T> handler) {
    ...
    public String getUnlocalizedName(Material material) {
        ...
        String matSpecificKey = String.format("item.%s_%s",
            this.invertedName ? formattedPrefix : material.getName(),
            this.invertedName ? material.getName() : formattedPrefix);
