...
public class GTMaterials {
    ...
    public static void init() {
        ...
        /*
         * ChemicalHelper.registerUnificationEntry(MetaBlocks.STONE_SMOOTH.
         * getItemVariant(BlockStoneSmooth.BlockType.BLACK_GRANITE, 1), TagPrefix.stone,
         * GTMaterials.Deepslate);
         * ChemicalHelper.registerUnificationEntry(MetaBlocks.STONE_SMOOTH.
         * getItemVariant(BlockStoneSmooth.BlockType.RED_GRANITE, 1), TagPrefix.stone,
         * GTMaterials.GraniteRed);
         * ChemicalHelper.registerUnificationEntry(MetaBlocks.STONE_SMOOTH.
         * getItemVariant(BlockStoneSmooth.BlockType.MARBLE, 1), TagPrefix.stone,
         * GTMaterials.Marble);
         * ChemicalHelper.registerUnificationEntry(MetaBlocks.STONE_SMOOTH.
         * getItemVariant(BlockStoneSmooth.BlockType.BASALT, 1), TagPrefix.stone,
         * GTMaterials.Basalt);
         * ChemicalHelper.registerUnificationEntry(MetaBlocks.STONE_SMOOTH.
         * getItemVariant(BlockStoneSmooth.BlockType.CONCRETE_LIGHT, 1),
         * TagPrefix.block, GTMaterials.Concrete);
         * ChemicalHelper.registerUnificationEntry(MetaBlocks.STONE_SMOOTH.
         * getItemVariant(BlockStoneSmooth.BlockType.CONCRETE_DARK, 1), TagPrefix.block,
        ...
        MATERIAL_AMOUNT_MAP = ImmutableMap.ofEntries(
                ...
                // Blocks (4 materials)
                Map.entry(new UnificationEntry(TagPrefix.block, Amethyst), GTValues.M * 4),
                Map.entry(new UnificationEntry(TagPrefix.block, Brick), GTValues.M * 4),
                Map.entry(new UnificationEntry(TagPrefix.block, CertusQuartz), GTValues.M * 4),
                Map.entry(new UnificationEntry(TagPrefix.block, Clay), GTValues.M * 4),
                Map.entry(new UnificationEntry(TagPrefix.block, Glowstone), GTValues.M * 4),
                Map.entry(new UnificationEntry(TagPrefix.block, NetherQuartz), GTValues.M * 4),

                // Blocks (1 material)
                Map.entry(new UnificationEntry(TagPrefix.block, Concrete), GTValues.M),
                Map.entry(new UnificationEntry(TagPrefix.block, Glass), GTValues.M),
                Map.entry(new UnificationEntry(TagPrefix.block, Ice), GTValues.M),
                Map.entry(new UnificationEntry(TagPrefix.block, Obsidian), GTValues.M),

                // Stick materials
                Map.entry(new UnificationEntry(TagPrefix.rod, Blaze), GTValues.M * 4),
                Map.entry(new UnificationEntry(TagPrefix.rod, Bone), GTValues.M * 5)
    ...
    public static void addAlloyBlastProperty(@Nonnull Material material) {
        ...
        // if there are more than 2 fluid-only components in the material, do not
        // generate a hot fluid
        ...
        material.getProperty(PropertyKey.FLUID).getStorage().enqueueRegistration(FluidStorageKeys.MOLTEN,
                new FluidBuilder().state(FluidState.MOLTEN));
    }
